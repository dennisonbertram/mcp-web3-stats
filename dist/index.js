...
server.resource("dex_router_contracts", "web3-stats://contracts/dex-routers", {
...
server.resource("stablecoin_addresses", "web3-stats://tokens/stablecoins", {
...
server.resource("bridge_contracts", "web3-stats://contracts/bridges", {
...
server.resource("security_patterns", "web3-stats://security/patterns", {
...
server.resource("token_categories", "web3-stats://tokens/categories", {
...
server.prompt("defi_protocol_investigation", "Investigate a DeFi protocol by analyzing its core contracts, TVL, and user activity patterns.", {
...
server.prompt("token_launch_investigation", "Perform forensic analysis on a newly launched token to identify potential risks or scams.", {
    tokenAddress: z.string().describe("The token contract address"),
...
server.prompt("whale_movement_analysis", "Track and analyze large holder (whale) movements for a specific token or protocol.", {
...
server.prompt("nft_collection_forensics", "Comprehensive analysis of an NFT collection including rarity, trading patterns, and holder behavior.", {
...
server.prompt("bridge_transaction_verification", "Verify and analyze cross-chain bridge transactions for security and completion status.", {
...
server.prompt("mev_activity_detection", "Detect and analyze MEV (Maximum Extractable Value) activity including sandwich attacks and arbitrage.", {
...
server.prompt("gas_optimization_audit", "Analyze gas usage patterns and identify optimization opportunities for contracts or users.", {
...
server.prompt("dao_treasury_audit", "Comprehensive audit of a DAO treasury including assets, spending, and governance.", {
...
server.prompt("security_vulnerability_scan", "Scan smart contracts for common vulnerabilities and security best practices.", {
...
server.prompt("yield_strategy_comparison", "Compare and analyze DeFi yield strategies across protocols.", {
